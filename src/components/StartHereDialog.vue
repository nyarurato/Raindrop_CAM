      ...
      <v-card-text>
        ...
        <div v-else-if="currentStep === 1">
          ...
          <v-row>
            ...
            <v-col>
              <div>
                座標系は工具先端の座標とし、ワーク原点は工具先端で取ります。<br />
                半径方向座標0は工具先端が半径方向回転中心にあることを意味します。
              </div>
              <v-img
                width="12vw"
                class="path_img"
            ...
            <v-col>
              <div>
                現verでは加工パスは単純に半径方向オフセット、及び接触点の計算を行っていないため、断面形状によっては指定形状に干渉することがあります。
              </div>
        ...
        <div v-else-if="currentStep === 3">
          ...
          <div class="ml-5">
            <ul>
              ...
              <li>
                大きな形状の場合、シミュレーション及びシミュレーション結果の描画に時間がかかります。
              </li>
            </ul>
          </div>
